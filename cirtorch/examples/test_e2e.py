...
parser = argparse.ArgumentParser(
    description='PyTorch CNN Image Retrieval Testing End-to-End')
...
def main():
    ...
    state = load_url(PRETRAINED[args.network], model_dir=os.path.join(
    ...
    for dataset in datasets:
        ...
        qvecs = extract_vectors(
            net, qimages, args.image_size, transform, bbxs=bbxs, ms=ms)
