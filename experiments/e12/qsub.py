...
module load cudnn/7.0/7.0.5
module load nccl/2.1/2.1.15-1

source ~/anaconda3/bin/activate landmark19 &&\\
    PYTHONPATH=/home/aca10305wp/trunk/models_190505/research:lib {cmd_str:s}
"""
...
def qsub(cmd_with_args, n_hours=1, instance_type='rt_C.small'):
